    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6">
          <p className={styles.fountText}>筋膜按摩球</p>
          <p className={styles.fountP}>
            放鬆肌肉 按摩球可以有效放鬆身體的緊張肌肉和筋膜。
          </p>
          <p className={styles.fountPrice}>NT$1200</p>
          <p className={styles.fountTitle}>商品介紹｜</p>
          <p className={styles.fountP}>
      ...
      <div className="row  text-center align-items-center">
        <div className="col-12 col-md-12">
          <p className={styles.sectionTitle}>你可能喜歡</p>
        </div>
      </div>
    </div>
  )
